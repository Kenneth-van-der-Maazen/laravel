<header class="klm-header">
    ...
    <div class="klm-container">
        ...
        <a class="klm-brand" href="{{ url('/') }}">
            ...
            <span class="klm-brand-text">Het Goede Leven</span>
        </a>
    ...
    <div class="klm-container">
        ...
        <a class="klm-nav-link {{ request()->is('/') ? 'is-active' : '' }}" href="{{ url('/') }}">Zoeken</a>

        <a class="klm-nav-link" href="/en/tickets">Mijn Reis</a>
        <a class="klm-nav-link" href="/en/trips">Aanbevolen</a>
        ...
        <a class="klm-nav-link" href="/en/information/support">Ondersteuning</a>
    </div>
</nav>
